...
public interface ILocationService {
	...
	@GET("/api/jayab/location/find")
	PPaginatorPage<Location> findLocation(@Query("latitude") double latitude, @Query("longitude") double longitude,
			@Query("count") Integer count, @Query("radius") Double radius, @Query("tag_key") String tagKey,
			@Query("tag_value") String tagValue);

	@GET("/api/jayab/location/find")
	void findLocation(@QueryMap Map<String, Object> params, Callback<PPaginatorPage<Location>> callBack);

	@GET("/api/jayab/location/find")
	PPaginatorPage<Location> findLocation(@QueryMap Map<String, Object> params);

	@GET("/api/jayab/location/list")
	void listLocations(@QueryMap Map<String, Object> params, Callback<PPaginatorPage<Location>> callBack);
